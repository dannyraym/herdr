...
| Stack a new pane onto the focused pane | `prefix+shift+s` |
| Unstack (peel a pane off the stack) | `prefix+shift+u` |
| Break the focused pane out into a new tab | `prefix+shift+b` |
| Close pane | `prefix+x` |
